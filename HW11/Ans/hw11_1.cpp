...
int main()
{
	...
	while (1)
	{
		...
		if (sInput == "A" || sInput == "a")
		{
			...
			myBST.add(aString);
			cout << endl
				 << "The inorder traversal after Add is " << endl;
			myBST.inorderTraverse(display);
			cout << endl
				 << "The levelorder traversal after Add is " << endl;
		...
		else if (sInput == "R" || sInput == "r")
		{
			...
			try
			{
				...
				{
					cout << endl
						 << "The inoder traversal after Remove is " << endl;
					myBST.inorderTraverse(display);
					cout << endl
						 << "The levelorder traversal after Remove is " << endl;
					myBST.levelorderTraverse(display);
				}
			}
			catch (...)
		...
		else if (sInput == "C" || sInput == "c")
		{
			...
			cout << endl
				 << "The inoder traversal after Count is " << endl;
			myBST.inorderTraverse(display);
			cout << endl
				 << "The levelorder traversal after Count is " << endl;
			myBST.levelorderTraverse(display);
		}
