	...
	while (1) {
		...
		if (sInput == "A" || sInput == "a") {
			...
			if (myBST.isAllTwoChildrenR(key))
				cout << endl << "R: " << key << " and it's decendent have two children." << endl;
			else
				cout << endl << "R: " << key << " or it's decendent do not have two children." << endl;

			if (myBST.isAllTwoChildrenI(key))
				cout << endl << "I: " << key << " and it's decendent have two children.";
			else
				cout << endl << "I: " << key << " or it's decendent do not have two children." << endl;

		}
		else if (sInput == "N" || sInput == "n") {
			cout << endl << "I: Number of the nodes with two children is " << myBST.nodesOfTwoChildrenI();
			cout << endl << "R: Number of the nodes with two children is " << myBST.nodesOfTwoChildrenR() << endl;
		}
